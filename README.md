...
##### HotUpdate 的后台配置（若是文件，文件编码最好是utf-8，即普通文本文件）（配置后台文件或接口(get请求)，自由选择）例如下列示例(有一个我测试放在后台的json文件，在[lib文件夹](https://github.com/gegeyang0124/react-native-update-js/blob/master/lib/update.json)下，可参考)
```javascript
{
